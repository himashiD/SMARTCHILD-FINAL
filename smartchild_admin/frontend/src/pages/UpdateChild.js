...
export default function UpdateChild() {
  ...
  useEffect(() => {
    const fetchChildData = async () => {
      try {
        ...
        setCurrentImage(data.child_image ? `${API}/uploads/${data.child_image}` : null);
      } catch (error) {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`${API}/api/children/${id}`, fd, {
  ...
  return (
    <div className="page-container">
      ...
      <nav className="breadcrumb">
        ...
        <span className="breadcrumb-separator">›</span>
        <span className="breadcrumb-item active">Update Registration</span>
      </nav>
      ...
      <div className="form-card">
        ...
        <div className="form-header">
          <div className="form-title-section">
            ...
            <div>
              <h1 className="form-title">UPDATE CHILD REGISTRATION</h1>
              <p className="form-subtitle">Modify child information and account details</p>
            </div>
          </div>
          <div className="form-meta">
            <div className="form-id">Child ID: {id}</div>
        ...
        <form onSubmit={onSubmit} className="registration-form">
            ...
            <div className="photo-upload-container">
              <div className="photo-upload-area" onClick={triggerFileUpload}>
                {preview || currentImage ? (
                  <img src={preview || currentImage} alt="Child preview" className="photo-preview" />
                ) : (
              ...
              <div className="photo-controls">
                <button type="button" className="attach-btn" onClick={triggerFileUpload}>
                  {preview || currentImage ? 'CHANGE PHOTO' : 'ATTACH PHOTO'}
                </button>
          ...
          <div className="form-section">
            <div className="section-header">
              ...
              <p className="section-subtitle">Update the child's basic personal details</p>
            </div>
          ...
          <div className="form-section">
            <div className="section-header">
              ...
              <p className="section-subtitle">Update parent or guardian contact details</p>
            </div>
          ...
          <div className="form-section">
            <div className="section-header">
              ...
              <p className="section-subtitle">Update login credentials for the child's account</p>
            </div>
            ...
            <div className="form-grid">
              ...
              <div className="form-group">
                ...
                <div className="form-note">Leave password field empty to keep the current password</div>
              </div>
            </div>
          </div>
